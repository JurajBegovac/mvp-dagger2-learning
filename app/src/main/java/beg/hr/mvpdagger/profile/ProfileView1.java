...
public class ProfileView1 extends ProfileView {

    @BindView(R.id.name)      TextView m_name;
    @BindView(R.id.presenter) TextView m_presenterName;

    public ProfileView1(Context context) {
        this(context, null);
    }
    public ProfileView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public ProfileView1(Context context, AttributeSet attrs, int defStyleAttr) {
